...
export const SessionView: React.FC<SessionViewProps> = ({
    ...
    return (
        <div className="flex-1 flex flex-col h-full relative overflow-hidden bg-[var(--color-background)]">
            {/* Session Breadcrumbs / Header - Fixed top */}
            <div className="flex-shrink-0 px-4 py-2 sm:px-6 sm:py-3 border-b border-white/5 bg-[var(--color-surface)]/80 backdrop-blur-sm z-10 flex items-center gap-2 text-sm sticky top-0">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-background)] via-[var(--color-background)] to-transparent" style={{ top: '-40px' }} />
